            ...
            <div className="bg-white shadow-lg rounded-lg p-8">
                ...
                <div className="flex flex-wrap items-center gap-4 mb-6">
                    <input
                        ...
                        onChange={handleFilterChange}
                        placeholder="Filter by Name"
                        className="border p-2 rounded-md w-full sm:w-1/2 lg:w-1/4"
                    />
                    ...
                    <button
                        onClick={exportToExcel}
                        className="bg-green-600 text-white px-2 py-2 rounded-md flex items-center gap-2 mb-4 mr-2 hover:bg-green-700 transition shrink-0"
                    >
                        <Download size={16} /> Export
                    </button>
                </div>
                            ...
                            <tbody>
                                {filteredData.map((item, index) => (
                                    <tr
                                        ...
                                        className="text-center bg-gray-50 hover:bg-gray-100 transition"
                                    >
                                        {/* Update SI.NO to reflect correct serial numbering */}
